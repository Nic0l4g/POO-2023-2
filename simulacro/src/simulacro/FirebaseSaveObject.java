    ...
    private void initFirebase() throws FileNotFoundException {
        ...
        try {
            ...
            FirebaseOptions firebaseOptions = new FirebaseOptions.Builder()
                    .setDatabaseUrl("https://menu-5471d-default-rtdb.firebaseio.com/")
                    
                    .setServiceAccount(new FileInputStream(new File("C:\\Users\\nicga\\OneDrive\\Escritorio\\programacion\\simulacro\\menu-5471d")))
